/* DHT 11 on LCD 
This code displays temperature and humidity readings from a DHT11 sensor on both Serial Monitor and LCD.
*/
...
void loop() {
  // Display temperature and humdity from DHT11 sensor on the Serial Monitor
  ...
  // Display Temperature value with degree Celsius symbol
  else {
