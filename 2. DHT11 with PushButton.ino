...
This code displays temperature and humidity data readings from a DHT11 sensor on an LCD screen. 
A pushbutton is connected to alternate between showing temperature in both Celsius and Fahrenheit and humidity data.
*/
