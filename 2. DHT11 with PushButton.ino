...
This code displays temperature and humidity values measured from a DHT11 sensor
on LCD screen. A pushbutton is also connected to alternate between showing the
values of temperature in both Celsius and Fahrenheit and humidity.
*/
