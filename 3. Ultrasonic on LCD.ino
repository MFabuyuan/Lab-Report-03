/* Ultrasonic on LCD
This code uses an ultrasonic sensor that measures the distance between the
sensor and the object in front of it. The measured distance value will be
displayed on both Serial Monitor and LCD.
*/
...
void loop() {
  ...
  // Recommended minimum delay between the trigger signal and the start of
  // the echo pulse
