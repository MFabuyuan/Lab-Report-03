/* Ultrasonic on LCD
This code uses an ultrasonic sensor that measures the distance between the sensor and the object in front of it. The Serial monitor and LCD screed will both display the measured distance.
*/
...
// Declare variables to hold the duration and distance values 
float duration;
float distance;
...
void loop() {
  ...
  // Print the meausured Distance on the Serial Monitor
