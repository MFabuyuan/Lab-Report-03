...
This code uses DHT 11 sensor to measure temperature and humidity values. It also uses Ultrasonic sensor to calculate the distance of an object using the speed of sound. Ultrsonic sensor uses the temperature and humidity of values from the DHT 11 sensor to calculate the speed of sound. This code displays temperature, humidity, speed of sound (cm/ms) and distance (cm) values on LCD and on Serial Monitor. A pushbutton is also connected to alternate between showing the values. 
*/
